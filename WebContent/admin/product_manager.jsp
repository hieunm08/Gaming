				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">
							<a href="product_manager.jsp"><button type="button"
												...
												<tbody>
													...
													<tr class="gradeA odd" role="row">
														...
														<td width="120px">
															<center>
																<a
																	href="product_manager.jsp?action=edit&productID=<%=product.getProductID()%>"><button
																		type="button" class="btn btn-info"
																		style="padding: 5px;">Edit</button></a> <a
																	href="${pageContext.request.contextPath}/managerProduct?action=delete&productID=<%=product.getProductID()%>"><button
																		type="button" class="btn btn-danger"
																		style="padding: 5px;">Delete</button></a>
						...
						<div class="panel-body">
							<div class="row">
								<div class="col-lg-6">
									...
									<form role="form"
										action="${pageContext.request.contextPath}/managerProduct"
										method="GET">
										<div class="form-group">
											<label>ID</label> <input class="form-control"
												placeholder="Enter text" name="productID"
												value="<%=request.getParameter("productID") %>" disabled>
										</div>
										<div class="form-group">
											<label>Tên sản phẩm</label> <input class="form-control"
												placeholder="Enter text" name="productName">
										</div>
										<div class="form-group">
											<label>Giá</label> <input class="form-control"
												placeholder="Enter text" name="productPrice">
										</div>
										<div class="form-group">
											<label>Hãng</label> <input class="form-control"
												name="productBrand">
											<p class="help-block">Example block-level help text here.</p>
										</div>
										<div class="form-group">
											<label>Ảnh</label> <input type="file" name="productImage">
										</div>
