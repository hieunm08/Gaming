...
<%
	...
	listServices = serviceDAOImpl.getAll();
	String action = "";
			...
			<div class="col-xs-12">
				<div class="box">
					<div class="box-header">
						...
						<div class="col-xs-1">
							<a href="service_manager.jsp?action=create"><button type="button"
									class="btn btn-primary top_button">Add Service</button></a>
						</div>
					</div>
					<!-- /.box-header -->
					<div class="box-body">
									...
									<table id="example2"
										...
										<thead>
											<tr role="row">
												...
												<th class="sorting" tabindex="0" aria-controls="example2"
													...
													<th class="sorting" tabindex="0" aria-controls="example2"
													rowspan="1" colspan="1"
													aria-label="Browser: activate to sort column ascending">Type Service</th>
												<th class="sorting" tabindex="0" aria-controls="example2"
													rowspan="1" colspan="1"
										...
										<tbody>
											...
											<tr role="row" class="odd">
												...
												<td><%=service.getId_service()%></td>
												<td><%=service.getNameService()%></td>
												<td><%=service.getPriceService()%></td>
												<td><%=service.getId_type()%></td>
												<td><%=service.getNote()%></td>
												<td>
												<a href="service_manager.jsp?action=edit&id_service<%=service.getId_service()%>"><button type="button" class="btn btn-info" style="padding: 5px;">Edit</button></a>
												<a href="service_manager.jsp.jsp?action=delete&id_service=<%=service.getId_service()%>"><button type="button" class="btn btn-danger"
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-6">
								...
								<form role="form"
									action="${pageContext.request.contextPath}/ServiceManager"
									method="POST">
									<div class="form-group">
										<label>ID</label> <input class="form-control"
											placeholder="Enter text" name="id_service"
											value="<%=request.getParameter("id_service")%>" disabled>
									</div>
									<div class="form-group">
										<label>Name</label> <input class="form-control"
											placeholder="Enter text" name=nameService>
									</div>
									
										<div class="form-group">
										<label>Price</label> <input class="form-control"
											placeholder="Enter text" name=priceService>
									</div>
									<div class="form-group">
											<label>Type Service</label> <select class="form-control"
												name="id_type">
				
												<% for(TypeService typeService : listTypeService) {%>
												<option value="<%=typeService.getId_type() %>"><%=typeService.getName_type() %></option>
										 		<% } %>
											</select>
										</div>  
									<div class="form-group">
									...
									<input type="hidden" name="id_service"
										value="<%=request.getParameter("id_service")%>">
